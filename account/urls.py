...
urlpatterns = [
    ...
    path('reset/', views.UserPasswordReserView.as_view(), name='reset_password'),
    path('reset/done/', views.UserPasswordResetDoneView.as_view(),
         name='password_reset_done'),
    path('confrim/<uidb64>/<token>/',
         views.UserPasswordResetConfrimView.as_view(), name='password_reset_confrim'),
    path('confrim/comlete/', views.UserPasswordResetCompleteView.as_view(),
